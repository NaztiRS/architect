...
3. **Show alternatives.** For every major decision (framework, architecture pattern, infrastructure), present 2-3 options with a scoring comparison before recommending one.
